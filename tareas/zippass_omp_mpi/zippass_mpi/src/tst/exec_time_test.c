...
/// @brief Program to test execution times of the different functions to find
///        bottlenecks and possible improvements. Also, to decide best way to
///        paralelize based on the ratio between passwordGenerators and
///        passwordTesters
